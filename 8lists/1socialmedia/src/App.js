    ...
    friends: [
      {
        ...
        pic:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQF0T7KN_z_b46kIHmE7QgNrWxar0WvVtKmTnw8tYUcNd-_JJbB",
        id: 1
      },
      {
        fullname: "Henny Blues",
        pic: "http://jqlacorte.com/wp-content/uploads/2015/09/jql-profiles.png",
        id: 2
      },
      {
        fullname: "Matt Weens",
    ...
    return (
      <div>
        <ul>
          ...
          <li>Link 1</li>
          <li>Link 1</li>
          <li onClick={this.HandleLog}>{this.state.log}</li>
        </ul>
        <h1>Welcome to Gerbook</h1>
        <div style={logdisplay}>
          <Profile
